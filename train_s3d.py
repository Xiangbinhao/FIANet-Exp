...
import time
import torch
from lib.weak_evidence_conditional_refinement import WeakEvidenceConditionalResidualWrapper
...
def main(args):
    ...
    # resume training
    # ========================================================
    # S3-D: wrap the existing S2 high-resolution residual head
    ...
    if getattr(
        ...
        raise RuntimeError(
            "S3-D requires --use-small-refine, but "
    ...
    print(
        ...
        "alpha_init=0.10, gate_init=0.20, ""relax_init=0.75, ambiguity_center=0.20, ""ambiguity_temperature=0.05"
    )

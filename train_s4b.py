# ============================================================
# S4-B model-construction patch
# ============================================================
import lib.segmentation as _s4b_segmentation

from lib.identity_semantic_modulation_refinement import (
    IdentitySemanticModulationRefinementHead,
)


_s4b_original_lavt_one = (
    _s4b_segmentation.lavt_one
)


def _s4b_lavt_one(*call_args, **call_kwargs):
    model = _s4b_original_lavt_one(
        *call_args,
        **call_kwargs
    )
    ...
    if getattr(
        ...
        raise RuntimeError(
            "S4-B first experiment is fixed to "
            "--swin_type base."
        )
    ...
    if base_head is None:
        raise RuntimeError(
            "S4-B requires --use-small-refine "
    ...
    print(
        "S4-B semantic-guided high-resolution "
        "refinement enabled: "
...
def main(args):
    ...
    if getattr(
        ...
        print(
            "S4-B optimizer added refinement parameters: "
            "{}".format(
                sum(
                    parameter.numel()
                    for parameter

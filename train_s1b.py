...
from loss.size_aware_loss import SizeAwareSegmentationLoss
...
def main(args):
    ...
    # S1-B modifies only the training loss.
    # Validation continues to use the original E0 loss.
    ...
    if getattr(
        ...
        train_criterion = (
            SizeAwareSegmentationLoss(
                tiny_weight=(
                    args.s1b_tiny_weight
                ),
                small_weight=(
                    args.s1b_small_weight
                ),
                medium_weight=(
                    args.s1b_medium_weight
                ),
                large_weight=(
                    args.s1b_large_weight
                ),
                empty_weight=(
                    args.s1b_empty_weight
                ),
                tiny_max_ratio=(
        ...
        print(
            "Sampler: original RandomSampler"
        )

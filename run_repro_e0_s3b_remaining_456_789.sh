...
MASTER_STATUS="experiments/repro_E0_S3B_3seed/run_status_remaining_456_789.tsv"
...
run_e0() {
    ...
    echo "Pruning E0 model_last checkpoints for seed=${seed}"
    find "${output_dir}"         -maxdepth 1         -type f         -name "model_last_*.pth"         -print -delete
...
run_s3b() {
    ...
    echo "Pruning S3-B model_last checkpoints for seed=${seed}"
    find "${output_dir}"         -maxdepth 1         -type f         -name "model_last_*.pth"         -print -delete

...
import time
import torch
from lib.main_logit_evidence_refinement import MainLogitEvidenceConditionalResidualWrapper
...
def main(args):
    ...
    # resume training
    # ========================================================
    # S3-E: wrap the existing S2 high-resolution residual head
    ...
    if getattr(
        ...
        raise RuntimeError(
            "S3-E requires --use-small-refine, but "

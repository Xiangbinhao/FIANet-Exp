...
import time
import torch
from lib.positive_preserving_asymmetric_refinement import PositivePreservingAsymmetricResidualWrapper
...
def main(args):
    ...
    # resume training
    # ========================================================
    # S3-C: wrap the existing S2 high-resolution residual head
    ...
    if getattr(
        ...
        raise RuntimeError(
            "S3-C requires --use-small-refine, but "

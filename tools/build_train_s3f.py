...
# Optional display-name replacements.
text = text.replace(
    "S3-B",
    "S3-F",
)
...
if missing:
    raise RuntimeError(
        "Generated train_s3f.py missing: "
        "{}".format(missing)
    )
...
print(
    "S3-F training entry generation: PASS"
)
